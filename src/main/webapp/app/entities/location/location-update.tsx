    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="fieldManagementApp.location.home.createOrEditLabel">
              <Translate contentKey="fieldManagementApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : locationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="streetAddressLabel" for="streetAddress">
                    <Translate contentKey="fieldManagementApp.location.streetAddress">Street Address</Translate>
                  </Label>
                  <AvField id="location-streetAddress" type="text" name="streetAddress" />
                </AvGroup>
                <AvGroup>
                  <Label id="postalCodeLabel" for="postalCode">
                    <Translate contentKey="fieldManagementApp.location.postalCode">Postal Code</Translate>
                  </Label>
                  <AvField id="location-postalCode" type="text" name="postalCode" />
                </AvGroup>
                <AvGroup>
                  <Label id="cityLabel" for="city">
                    <Translate contentKey="fieldManagementApp.location.city">City</Translate>
                  </Label>
                  <AvField id="location-city" type="text" name="city" />
                </AvGroup>
                <AvGroup>
                  <Label id="stateProvinceLabel" for="stateProvince">
                    <Translate contentKey="fieldManagementApp.location.stateProvince">State Province</Translate>
                  </Label>
                  <AvField id="location-stateProvince" type="text" name="stateProvince" />
                </AvGroup>
                <AvGroup>
                  <Label for="country.id">
                    <Translate contentKey="fieldManagementApp.location.country">Country</Translate>
                  </Label>
                  <AvInput id="location-country" type="select" className="form-control" name="countryId" onChange={this.countryUpdate}>
                    <option value="" key="0" />
                    {countries
