...
export class Task extends React.Component<ITaskProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="task-heading">
          <Translate contentKey="fieldManagementApp.task.home.title">Tasks</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="fieldManagementApp.task.home.createLabel">Create new Task</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="fieldManagementApp.task.title">Title</Translate>
                </th>
                <th>
                  <Translate contentKey="fieldManagementApp.task.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
