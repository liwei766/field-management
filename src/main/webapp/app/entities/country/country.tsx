    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="fieldManagementApp.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="fieldManagementApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </h2>
