...
export interface IJobHistoryUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="fieldManagementApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="fieldManagementApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="startDate">
                    <Translate contentKey="fieldManagementApp.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="endDate">
                    <Translate contentKey="fieldManagementApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel">
                    <Translate contentKey="fieldManagementApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">
                      <Translate contentKey="fieldManagementApp.Language.FRENCH" />
                    </option>
                    <option value="ENGLISH">
                      <Translate contentKey="fieldManagementApp.Language.ENGLISH" />
                    </option>
                    <option value="SPANISH">
                      <Translate contentKey="fieldManagementApp.Language.SPANISH" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job.id">
                    <Translate contentKey="fieldManagementApp.jobHistory.job">Job</Translate>
                  </Label>
                  <AvInput id="job-history-job" type="select" className="form-control" name="jobId" onChange={this.jobUpdate}>
                    <option value="" key="0" />
                    {jobs
                ...
                <AvGroup>
                  <Label for="department.id">
                    <Translate contentKey="fieldManagementApp.jobHistory.department">Department</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label for="employee.id">
                    <Translate contentKey="fieldManagementApp.jobHistory.employee">Employee</Translate>
                  </Label>
                  <AvInput
