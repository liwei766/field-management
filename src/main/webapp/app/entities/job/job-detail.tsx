...
export interface IJobDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="fieldManagementApp.job.detail.title">Job</Translate> [<b>{jobEntity.id}</b>]
          </h2>
