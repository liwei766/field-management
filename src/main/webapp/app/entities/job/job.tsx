...
export class Job extends React.Component<IJobProps, IJobState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="job-heading">
          <Translate contentKey="fieldManagementApp.job.home.title">Jobs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="fieldManagementApp.job.home.createLabel">Create new Job</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('jobTitle')}>
                  <Translate contentKey="fieldManagementApp.job.jobTitle">Job Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('minSalary')}>
                  <Translate contentKey="fieldManagementApp.job.minSalary">Min Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('maxSalary')}>
                  <Translate contentKey="fieldManagementApp.job.maxSalary">Max Salary</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="fieldManagementApp.job.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
