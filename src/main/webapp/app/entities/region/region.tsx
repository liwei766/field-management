    ...
    return (
      <div>
        <h2 id="region-heading">
          <Translate contentKey="fieldManagementApp.region.home.title">Regions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="fieldManagementApp.region.home.createLabel">Create new Region</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="fieldManagementApp.region.regionName">Region Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
